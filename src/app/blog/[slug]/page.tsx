    ...
    <Wrapper>
      <div className="flex">
        <div className="flex-1 sticky max-md:hidden top-[100px] h-full">
          <Link href={`/blog`} className="flex items-center gap-2 text-white">
            <svg
        ...
        <div className="flex-[2] pr-52 max-lg:pr-0 text-white">
          <h5 className="mb-2 text-[32px] max-md:text-[24px] font-bold tracking-tight text-white">
            {blog.fields.title}
          </h5>
